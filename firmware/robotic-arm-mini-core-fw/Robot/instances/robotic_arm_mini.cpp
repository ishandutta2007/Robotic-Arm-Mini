...
RoboticArmMini::RoboticArmMini(CAN_HandleTypeDef* _hcan) :
    hcan(_hcan)
{
...
void RoboticArmMini::MoveJoints(DOF6Kinematic::Joint6D_t _joints)
{
    for (int j = 1; j <= 6; j++)
    {
...
bool RoboticArmMini::MoveJ(float _j1, float _j2, float _j3, float _j4, float _j5, float _j6)
{
...
bool RoboticArmMini::MoveL(float _x, float _y, float _z, float _a, float _b, float _c)
{
...
void RoboticArmMini::UpdateJointAngles()
{
    motorJ[ALL]->UpdateAngle();
}


void RoboticArmMini::UpdateJointAnglesCallback()
{
    for (int i = 1; i <= 6; i++)
    {
...
void RoboticArmMini::SetJointSpeed(float _speed)
{
...
void RoboticArmMini::SetJointAcceleration(float _acc)
{
    if (_acc < 0)_acc = 0;
...
void RoboticArmMini::CalibrateHomeOffset()
{
...
void RoboticArmMini::SetEnable(bool _enable)
{
...
void RoboticArmMini::UpdateJointPose6D()
{
...
bool RoboticArmMini::IsMoving()
{
    return jointsStateFlag != 0b1111110;
}


bool RoboticArmMini::IsEnabled()
{
    return isEnabled;
}


void RoboticArmMini::SetCommandMode(uint32_t _mode)
{
...
RoboticArmMiniHand::RoboticArmMiniHand(CAN_HandleTypeDef* _hcan, uint8_t
_id) :
...
void RoboticArmMiniHand::SetAngle(float _angle)
{
...
void RoboticArmMiniHand::SetMaxCurrent(float _val)
{
    if (_val > 1)_val = 1;
    if (_val < 0)_val = 0;
...
void RoboticArmMiniHand::SetEnable(bool _enable)
{
    if (_enable)
...
uint32_t RoboticArmMini::CommandHandler::Push(const std::string &_cmd)
{
...
void RoboticArmMini::CommandHandler::EmergencyStop()
{
...
std::string RoboticArmMini::CommandHandler::Pop(uint32_t timeout)
{
...
uint32_t RoboticArmMini::CommandHandler::GetSpace()
{
    return osMessageQueueGetSpace(commandFifo);
}


uint32_t RoboticArmMini::CommandHandler::ParseCommand(const std::string &_cmd)
{
    uint8_t argNum;
...
void RoboticArmMini::CommandHandler::ClearFifo()
{
    osMessageQueueReset(commandFifo);
}


void RoboticArmMini::TuningHelper::SetTuningFlag(uint8_t _flag)
{
    tuningFlag = _flag;
}


void RoboticArmMini::TuningHelper::Tick(uint32_t _timeMillis)
{
...
void RoboticArmMini::TuningHelper::SetFreqAndAmp(float _freq, float _amp)
{
    if (_freq > 5)_freq = 5;
